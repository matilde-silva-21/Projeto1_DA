// Created by José Miguel on 12/04/2022.
// Projeto 1 de Desenho de Algoritmos.

#ifndef PROJETO1_MAXHEAP_H
#define PROJETO1_MAXHEAP_H
...
template <class K, class V>
pair<K,V> MaxHeap<K,V>::removeMax() {
